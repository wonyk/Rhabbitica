...
# Main overaching function
def set_reminders(update, context):
    job = context.job_queue
    # Quotes and Stickers (every hour)
    job.run_repeating(callbackQuote, 3600, context=update)


def callbackQuote(context):
